function Dog() {
  ...
  this.notify = function() {
    ...
    this.log("dog.notify(): currentPercentage = " + currentPercentage);

    if(currentPercentage >= percent) {
      var message = currentPercentage + '% of your monthly allotment has been consumed! Best to try and not go over.';
